...
def tohtml(data,thisseason):
    ...
    top = "<table class='table table-bordered w-auto text-xsmall'><thead><tr>"
    strRW = ""
    ...
    strRW = strRW + "<tr>" + "<td>OU</td><td>" + data.OU() + "</td><td>" + str(data.closetotalavg()) + "</td>" + f(data.trd4season(thisseason)) + f(data.tre4season(thisseason)) + f(data.trf4season(thisseason)) + f(data.trg4season(thisseason)) + "<td>OU</td><td>" + data.OUseason(thisseason) + "</td><td>" + str(data.closetotalavgseason(thisseason)) + "</td>" +  "</tr></thead>"
    top = top +  strRW
    top = top + "</table>"
    ...
    table3 = "<table id=\"myTable2\" class='table table-bordered w-auto text-xsmall'><thead><tr>" \
             ...
             "<th style='color:blue'>Q1</th><th style='color:blue'>Q2</th><th style='color:blue'>Q3</th><th style='color:blue'>Q4</th><th style='color:blue'>Final</th>" \
              ...
              "<th style='color:blue'>OUm</th><th style='color:blue'>DPS</th>" \
               "<th style='color:blue'>DPA</th style='color:blue'><th style='color:blue'>SUr</th><th style='color:blue'>ATSr</th><th style='color:blue'>OUr</th></tr></thead><tbody>"
